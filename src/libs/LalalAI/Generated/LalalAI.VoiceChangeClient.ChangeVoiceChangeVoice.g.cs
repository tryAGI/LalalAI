...
namespace LalalAI
{
    public partial class VoiceChangeClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_ChangeVoiceChangeVoiceSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_ChangeVoiceChangeVoiceSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_ChangeVoiceChangeVoiceSecurityRequirement0,
            };
        partial void PrepareChangeVoiceChangeVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LalalAI.VoiceChangeParameters request);
        partial void PrepareChangeVoiceChangeVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LalalAI.VoiceChangeParameters request);
        partial void ProcessChangeVoiceChangeVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChangeVoiceChangeVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.TaskResponse> ChangeVoiceChangeVoiceAsync(

            global::LalalAI.VoiceChangeParameters request,
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ChangeVoiceChangeVoiceAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.TaskResponse>> ChangeVoiceChangeVoiceAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChangeVoiceChangeVoiceArguments(
            ...
            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChangeVoiceChangeVoiceSecurityRequirements,
                operationName: "ChangeVoiceChangeVoiceAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChangeVoiceChangeVoiceRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChangeVoiceChangeVoice",
                                methodName: "ChangeVoiceChangeVoiceAsync",
                                pathTemplate: "\"/api/v1/change_voice/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChangeVoiceChangeVoiceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::LalalAI.ApiException<global::LalalAI.AnyOf<global::LalalAI.ApiV1ErrorResponse, global::LalalAI.CommonErrorResponse>?>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChangeVoiceChangeVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LalalAI.TaskResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LalalAI.AutoSDKHttpResponse<global::LalalAI.TaskResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LalalAI.TaskResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.TaskResponse> ChangeVoiceChangeVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LalalAI.VoiceChangeParameters
            {
                SourceId = sourceId,
                Presets = presets,
            ...
            return await ChangeVoiceChangeVoiceAsync(
                request: __request,
                requestOptions: requestOptions,
