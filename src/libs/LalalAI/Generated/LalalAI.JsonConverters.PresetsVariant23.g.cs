...
{
    /// <inheritdoc />
    public class PresetsVariant23JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LalalAI.PresetsVariant23>
    {
        /// <inheritdoc />
        public override global::LalalAI.PresetsVariant23 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LalalAI.CheckV1ProgressResultPresetsDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LalalAI.CheckV1ProgressResultPresetsDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LalalAI.CheckV1ProgressResultPresetsDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LalalAI.DemuserSplitterPresetsV1? demuser = default;
            if (discriminator?.Label == global::LalalAI.CheckV1ProgressResultPresetsDiscriminatorLabel.Demuser)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ProgressResultPresetsDiscriminatorLabel.VoiceClean)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ProgressResultPresetsDiscriminatorLabel.StemSeparator)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ProgressResultPresetsDiscriminatorLabel.Multistem)
            {
            ...
            var __value = new global::LalalAI.PresetsVariant23(
                discriminator?.Label,
                demuser,
        ...
        public override void Write(
            ...
            global::LalalAI.PresetsVariant23 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
