...
{
    /// <inheritdoc />
    public sealed class CheckV1SuccessResultPresetsDiscriminatorLabelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LalalAI.CheckV1SuccessResultPresetsDiscriminatorLabel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::LalalAI.CheckV1SuccessResultPresetsDiscriminatorLabelExtensions.ToValueString(value.Value));
            }
        }
    }
}
