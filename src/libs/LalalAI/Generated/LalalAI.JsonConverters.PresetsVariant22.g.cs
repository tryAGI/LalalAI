...
{
    /// <inheritdoc />
    public class PresetsVariant22JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LalalAI.PresetsVariant22>
    {
        /// <inheritdoc />
        public override global::LalalAI.PresetsVariant22 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LalalAI.CheckV1ErrorResultPresetsDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LalalAI.CheckV1ErrorResultPresetsDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::LalalAI.CheckV1ErrorResultPresetsDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::LalalAI.DemuserSplitterPresetsV1? demuser = default;
            if (discriminator?.Label == global::LalalAI.CheckV1ErrorResultPresetsDiscriminatorLabel.Demuser)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ErrorResultPresetsDiscriminatorLabel.VoiceClean)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ErrorResultPresetsDiscriminatorLabel.StemSeparator)
            {
            ...
            if (discriminator?.Label == global::LalalAI.CheckV1ErrorResultPresetsDiscriminatorLabel.Multistem)
            {
            ...
            var __value = new global::LalalAI.PresetsVariant22(
                discriminator?.Label,
                demuser,
        ...
        public override void Write(
            ...
            global::LalalAI.PresetsVariant22 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
