...
namespace LalalAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::LalalAI.AutoSDKRetryOptions Retry { get; set; } = new global::LalalAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::LalalAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::LalalAI.IAutoSDKHook>();
        ...
        public global::LalalAI.AutoSDKClientOptions AddHook(
            global::LalalAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::LalalAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::LalalAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::LalalAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::LalalAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::LalalAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::LalalAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::LalalAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::LalalAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::LalalAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::LalalAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::LalalAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::LalalAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::LalalAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::LalalAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::LalalAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::LalalAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::LalalAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::LalalAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::LalalAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::LalalAI.AutoSDKClientOptions clientOptions,
            global::LalalAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::LalalAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::LalalAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::LalalAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::LalalAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::LalalAI.IAutoSDKHook, global::LalalAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::LalalAI.AutoSDKHookContext context)
        {
