...
namespace LalalAI
{
    public partial class BatchStemSeparationClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_BatchSplitSplitBatchVoiceCleanSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_BatchSplitSplitBatchVoiceCleanSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_BatchSplitSplitBatchVoiceCleanSecurityRequirement0,
            };
        partial void PrepareBatchSplitSplitBatchVoiceCleanArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LalalAI.BatchVoiceCleanSplitParameters request);
        partial void PrepareBatchSplitSplitBatchVoiceCleanRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LalalAI.BatchVoiceCleanSplitParameters request);
        partial void ProcessBatchSplitSplitBatchVoiceCleanResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchSplitSplitBatchVoiceCleanResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.BatchTasksResponse> BatchSplitSplitBatchVoiceCleanAsync(

            global::LalalAI.BatchVoiceCleanSplitParameters request,
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BatchSplitSplitBatchVoiceCleanAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.BatchTasksResponse>> BatchSplitSplitBatchVoiceCleanAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchSplitSplitBatchVoiceCleanArguments(
            ...
            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BatchSplitSplitBatchVoiceCleanSecurityRequirements,
                operationName: "BatchSplitSplitBatchVoiceCleanAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LalalAI.PathBuilder(
                                path: "/api/v1/split/batch/voice_clean/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBatchSplitSplitBatchVoiceCleanRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchSplitSplitBatchVoiceClean",
                                methodName: "BatchSplitSplitBatchVoiceCleanAsync",
                                pathTemplate: "\"/api/v1/split/batch/voice_clean/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBatchSplitSplitBatchVoiceCleanResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::LalalAI.ApiException<global::LalalAI.CommonErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchSplitSplitBatchVoiceCleanResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LalalAI.BatchTasksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LalalAI.AutoSDKHttpResponse<global::LalalAI.BatchTasksResponse>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::LalalAI.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LalalAI.BatchTasksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await BatchSplitSplitBatchVoiceCleanAsync(
                request: __request,
                requestOptions: requestOptions,
