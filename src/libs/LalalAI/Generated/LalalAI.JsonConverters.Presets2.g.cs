...
{
    /// <inheritdoc />
    public class Presets2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::LalalAI.Presets2>
    {
        /// <inheritdoc />
        public override global::LalalAI.Presets2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::LalalAI.PresetsVariant22? presetsVariant22 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LalalAI.PresetsVariant22), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LalalAI.PresetsVariant22> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::LalalAI.PresetsVariant22).Name}");
                        presetsVariant22 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (voiceChangePresetsV1 == null && presetsVariant22 == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LalalAI.VoiceChangePresetsV1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LalalAI.VoiceChangePresetsV1> ??
            ...
            var __value = new global::LalalAI.Presets2(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsPresetsVariant22)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::LalalAI.PresetsVariant22), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::LalalAI.PresetsVariant22> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::LalalAI.PresetsVariant22).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PresetsVariant22!.Value, typeInfo);
            }
        }
    }
}