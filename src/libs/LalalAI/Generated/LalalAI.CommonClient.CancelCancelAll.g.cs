...
namespace LalalAI
{
    public partial class CommonClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_CancelCancelAllSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_CancelCancelAllSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_CancelCancelAllSecurityRequirement0,
            };
        partial void PrepareCancelCancelAllArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCancelCancelAllRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCancelCancelAllResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelCancelAllResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.CancelResponse> CancelCancelAllAsync(
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelCancelAllAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.CancelResponse>> CancelCancelAllAsResponseAsync(
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelCancelAllArguments(
                httpClient: HttpClient);


            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CancelCancelAllSecurityRequirements,
                operationName: "CancelCancelAllAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CancelCancelAll",
                                methodName: "CancelCancelAllAsync",
                                pathTemplate: "\"/api/v1/cancel/all/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelCancelAllResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelCancelAllResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LalalAI.CancelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LalalAI.AutoSDKHttpResponse<global::LalalAI.CancelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LalalAI.CancelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
