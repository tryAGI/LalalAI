...
namespace LalalAI
{
    public partial class CommonClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_LimitsGetMinutesLeftSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_LimitsGetMinutesLeftSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_LimitsGetMinutesLeftSecurityRequirement0,
            };
        partial void PrepareLimitsGetMinutesLeftArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareLimitsGetMinutesLeftRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessLimitsGetMinutesLeftResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLimitsGetMinutesLeftResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.LimitsResponse> LimitsGetMinutesLeftAsync(
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LimitsGetMinutesLeftAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.LimitsResponse>> LimitsGetMinutesLeftAsResponseAsync(
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareLimitsGetMinutesLeftArguments(
                httpClient: HttpClient);


            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_LimitsGetMinutesLeftSecurityRequirements,
                operationName: "LimitsGetMinutesLeftAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::LalalAI.PathBuilder(
                                path: "/api/v1/limits/minutes_left/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLimitsGetMinutesLeftRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LimitsGetMinutesLeft",
                                methodName: "LimitsGetMinutesLeftAsync",
                                pathTemplate: "\"/api/v1/limits/minutes_left/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLimitsGetMinutesLeftResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLimitsGetMinutesLeftResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LalalAI.LimitsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LalalAI.AutoSDKHttpResponse<global::LalalAI.LimitsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LalalAI.LimitsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
