...
namespace LalalAI
{
    public partial class BatchStemSeparationClient
    {
        ...
        {
            var __response = await BatchSplitSplitBatchEnhancedAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.BatchTasksResponse>> BatchSplitSplitBatchEnhancedAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchSplitSplitBatchEnhanced",
                                methodName: "BatchSplitSplitBatchEnhancedAsync",
                                pathTemplate: "\"/api/v1/split/batch/stem_separator/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
