...
namespace LalalAI
{
    public partial class StemSeparationClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_SplitSplitEnhancedSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_SplitSplitEnhancedSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_SplitSplitEnhancedSecurityRequirement0,
            };
        partial void PrepareSplitSplitEnhancedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LalalAI.StemSeparatorSplitParameters request);
        partial void PrepareSplitSplitEnhancedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LalalAI.StemSeparatorSplitParameters request);
        partial void ProcessSplitSplitEnhancedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSplitSplitEnhancedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.Task> SplitSplitEnhancedAsync(

            global::LalalAI.StemSeparatorSplitParameters request,
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SplitSplitEnhancedAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.Task>> SplitSplitEnhancedAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSplitSplitEnhancedArguments(
            ...
            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SplitSplitEnhancedSecurityRequirements,
                operationName: "SplitSplitEnhancedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSplitSplitEnhancedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LalalAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SplitSplitEnhanced",
                                methodName: "SplitSplitEnhancedAsync",
                                pathTemplate: "\"/api/v1/split/stem_separator/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSplitSplitEnhancedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSplitSplitEnhancedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.Task> SplitSplitEnhancedAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LalalAI.StemSeparatorSplitParameters
            {
                SourceId = sourceId,
                Presets = presets,
            ...
            return await SplitSplitEnhancedAsync(
                request: __request,
                requestOptions: requestOptions,
