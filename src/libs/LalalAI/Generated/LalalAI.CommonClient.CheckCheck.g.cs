...
namespace LalalAI
{
    public partial class CommonClient
    {
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement s_CheckCheckSecurityRequirement0 =
        ...
        private static readonly global::LalalAI.EndPointSecurityRequirement[] s_CheckCheckSecurityRequirements =
            new global::LalalAI.EndPointSecurityRequirement[]
            {                s_CheckCheckSecurityRequirement0,
            };
        partial void PrepareCheckCheckArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LalalAI.CheckV1Request request);
        partial void PrepareCheckCheckRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LalalAI.CheckV1Request request);
        partial void ProcessCheckCheckResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckCheckResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.CheckV1Response> CheckCheckAsync(

            global::LalalAI.CheckV1Request request,
            global::LalalAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CheckCheckAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::LalalAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::LalalAI.AutoSDKHttpResponse<global::LalalAI.CheckV1Response>> CheckCheckAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::LalalAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckCheckSecurityRequirements,
                operationName: "CheckCheckAsync");
                ...
                else
                {
                    await global::LalalAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::LalalAI.CommonErrorResponse? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::LalalAI.CommonErrorResponse.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckCheckResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LalalAI.CheckV1Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LalalAI.AutoSDKHttpResponse<global::LalalAI.CheckV1Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LalalAI.CheckV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LalalAI.CheckV1Response> CheckCheckAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LalalAI.CheckV1Request
            {
                TaskIds = taskIds,
            };

            return await CheckCheckAsync(
                request: __request,
                requestOptions: requestOptions,
